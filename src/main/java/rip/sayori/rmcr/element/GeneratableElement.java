...
import rip.sayori.rmcr.element.converter.ConverterRegistry;
...
public abstract class GeneratableElement {
	...
	public static class GSONAdapter
		...
		public GeneratableElement deserialize(JsonElement jsonElement, Type type,
			...
			ModElementType modElementType = jsonDeserializationContext.deserialize(
					jsonElement.getAsJsonObject().get("_type"), ModElementType.class);
			...
			for (Field field : object.getClass().getDeclaredFields()) {
				...
				try {
					...
					if (subobject instanceof MappableElement) {
						...
						if (subobject != null && subobject.getClass().getPackage().getName()
								.startsWith("rip.sayori.rmcr"))
