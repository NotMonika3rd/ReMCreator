...
package rip.sayori.rmcr.ui.ide;
...
import rip.sayori.rmcr.ui.MCreatorTabs;
import rip.sayori.rmcr.ui.component.JFileBreadCrumb;
...
import rip.sayori.rmcr.ui.laf.renderer.AstTreeCellRendererCustom;
...
public class CodeEditorView extends ViewBase {
	...
	public static boolean isFileSupported(String fileName) {
		return Arrays.asList("java", "info", "txt", "json", "mcmeta", "lang", "gradle", "ini", "conf", "xml",
						"properties", "toml", "js", "yaml", "yml", "md", "kts")
	...
	private void setupCodeSupport(String fileName) {
		if (fileName.endsWith(".java")) {
			...
			SwingUtilities.invokeLater(() -> te.setSyntaxEditingStyle(SyntaxConstants.SYNTAX_STYLE_KOTLIN));
