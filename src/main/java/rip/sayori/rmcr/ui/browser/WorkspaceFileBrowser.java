...
import rip.sayori.rmcr.ui.component.tree.FilteredTreeModel;
import rip.sayori.rmcr.ui.component.util.ComponentUtils;
import rip.sayori.rmcr.ui.component.util.PanelUtils;
import rip.sayori.rmcr.ui.component.util.TreeUtils;
import rip.sayori.rmcr.ui.component.util.WrapLayout;
			...
			for (LibraryInfo libraryInfo : libraryInfos) {
				...
				if (libraryFile.isFile() && (ZipIO.checkIfZip(libraryFile) || ZipIO.checkIfJMod(libraryFile))) {
					...
					if (libraryInfo.getSourceLocation() != null) {
						...
						ZipIO.iterateZip(libraryFile, (entry) -> lib.addElement(entry.getName()),false);
