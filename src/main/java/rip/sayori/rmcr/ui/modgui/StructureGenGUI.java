...
import rip.sayori.rmcr.ui.minecraft.BiomeListField;
import rip.sayori.rmcr.ui.minecraft.DimensionListField;
...
public class StructureGenGUI extends ModElementGUI<Structure> {
	...
	@Override protected void initGUI() {
		...
		generateCondition = new ProcedureSelector(this.withEntry("structure/condition"), mcreator,
				...
				L10N.t("elementgui.structuregen.event_additional_structure_condition_none"));
