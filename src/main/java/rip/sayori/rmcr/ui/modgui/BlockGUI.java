...
import rip.sayori.rmcr.element.parts.gui.InputSlot;
import rip.sayori.rmcr.element.parts.gui.OutputSlot;
import rip.sayori.rmcr.element.parts.gui.Slot;
...
import rip.sayori.rmcr.ui.component.util.ComboBoxFullWidthPopup;
...
import rip.sayori.rmcr.ui.laf.renderer.ItemTexturesComboBoxRenderer;
...
import rip.sayori.rmcr.ui.validation.validators.CommaSeparatedNumbersValidator;
...
public class BlockGUI extends ModElementGUI<Block> {
	...
	@Override protected void initGUI() {
		...
		JComponent parpar = PanelUtils.northAndCenterElement(particleParameters,
				PanelUtils.join(FlowLayout.LEFT, particleCondition));
