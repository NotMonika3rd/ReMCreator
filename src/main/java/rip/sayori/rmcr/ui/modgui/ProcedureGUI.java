...
import rip.sayori.rmcr.blockly.data.*;
...
import rip.sayori.rmcr.ui.blockly.ProcedureEditorToolbar;
import rip.sayori.rmcr.ui.component.util.ComponentUtils;
import rip.sayori.rmcr.ui.component.util.PanelUtils;
import rip.sayori.rmcr.ui.dialogs.NewVariableDialog;
...
public class ProcedureGUI extends ModElementGUI<rip.sayori.rmcr.element.types.Procedure> {
	...
	@Override public void openInEditingMode(rip.sayori.rmcr.element.types.Procedure procedure) {
	...
	@Override public rip.sayori.rmcr.element.types.Procedure getElementFromGUI() {
		rip.sayori.rmcr.element.types.Procedure procedure = new rip.sayori.rmcr.element.types.Procedure(modElement);
