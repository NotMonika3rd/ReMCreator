...
import rip.sayori.rmcr.blockly.data.ToolboxBlock;
...
import rip.sayori.rmcr.element.types.Mob;
...
import rip.sayori.rmcr.ui.blockly.AITasksEditorToolbar;
import rip.sayori.rmcr.ui.blockly.BlocklyPanel;
import rip.sayori.rmcr.ui.blockly.CompileNotesPanel;
...
import rip.sayori.rmcr.ui.laf.renderer.ModelComboBoxRenderer;
import rip.sayori.rmcr.ui.laf.renderer.WTextureComboBoxRenderer;
import rip.sayori.rmcr.ui.minecraft.*;
...
public class LivingEntityGUI extends ModElementGUI<Mob> {
	...
	@Override protected void initGUI() {
		...
		spawningCondition = new ProcedureSelector(this.withEntry("entity/condition_natural_spawning"), mcreator,
				...
				L10N.t("elementgui.living_entity.condition_use_vanilla"));
		...
		particles.add("West", PanelUtils.join(
				PanelUtils.northAndCenterElement(options, PanelUtils.join(FlowLayout.LEFT, particleCondition))));
		...
		JComponent selpcont = PanelUtils.northAndCenterElement(selp,
				PanelUtils.westAndEastElement(L10N.label("elementgui.living_entity.spawn_general_condition"),
