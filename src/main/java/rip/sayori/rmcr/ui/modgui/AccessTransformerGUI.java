...
public class AccessTransformerGUI extends ModElementGUI<AccessTransformer> {

	private final CodeEditorView codeEditorView;

	public AccessTransformerGUI(MCreator mcreator, ModElement modElement, boolean editingMode) {
	...
	@Override public void openInEditingMode(AccessTransformer generatableElement) {
	}

	@Override public AccessTransformer getElementFromGUI() {
		return null;
	}
