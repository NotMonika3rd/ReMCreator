			...
			try {
				...
				if (toolboxBlock != null) {
					...
					if (localized_message != null) {
						int parameters_count = StringUtils.countRegexMatches(localized_message, "%[0-9]+");
						int parameters_count_en = StringUtils.countRegexMatches(localized_message_en, "%[0-9]+");
